...
var create = function (params) {
    ...
    */
    ...
    if (params.implements && params.implements.length > 0) {
        ...
        params._iname = params.implements[0]._name;
    };
    ...
    var ObjectPrototype = function (data) {
        ...
        for (var i = this._implements.length - 1; i >= 0; i--) {
            var schema = this._implements[i] && this._implements[i].schema;
    ...
    common.checkMembers(ObjectPrototype, implementsInterfaces)
