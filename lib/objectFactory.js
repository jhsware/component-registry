...
import { extendPrototypeWithThese, addMembers, checkMembers } from './common';
...
export function createObjectPrototype(params) {
    ...
    */
    ...
    var ObjectPrototype = function ObjectPrototype(data) {
    ...
    ObjectPrototype.prototype.toJSON = function () {
        ...
        for (var key in this) {
            if (this.hasOwnProperty(key)) {
                ...
                var tmp = this[key];
                if (tmp && (typeof tmp === 'undefined' ? 'undefined' : _typeof(tmp)) === "object" && tmp.hasOwnProperty("_iname")) {
