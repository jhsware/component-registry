...
const { globalRegistry } = require('./index');
...
class Adapter {
    constructor (params, compat) {
       ...
       if (common.isDevelopment) {
            common.assert(typeof params.implements === 'function' && params.implements.interfaceId, '[componeont-registry] When creating an Adapter, param implements must be an interface!')
            common.assert((typeof params.implements === 'function' && params.implements.interfaceId)
