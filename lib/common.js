'use strict';
module.exports.isDevelopment = typeof process !== 'undefined' && process.env.NODE_ENV !== 'production';

module.exports.assert = function (isValid, msg) {
    if (!isValid) throw new Message(msg)
}
...
var checkMembers = function (ObjectPrototype, intrfcs) {
...
module.exports.checkMembers = checkMembers;