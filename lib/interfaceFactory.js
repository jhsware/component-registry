...
var NAMESPACE = 'bc901568-0169-42a8-aac8-52fa2ffd0670';
import { globalRegistry } from './index';

export function createInterfaceClass(namespace) {
    var Interface = function Interface(params, compat) {
        _classCallCheck(this, Interface);

        var outp = function Interface() {
            var paramOne = arguments[0],
                paramTwo = arguments[1];
            var registry = (paramTwo ? paramTwo.registry : paramOne && paramOne.registry) || globalRegistry;
            if ((typeof paramOne === 'undefined' ? 'undefined' : _typeof(paramOne)) === 'object' && paramOne._implements) {
                // Adapter lookup
...
//# sourceMappingURL=interfaceFactory.js.map