...
/**
 * TODO: consider changing how we create interfaces so we use a constructor instead
 * 
 * import { createInterfacePrototype } from 'component-registry'
 * const Interface = createInterfacePrototype(__dirname)
 * 
 * const interfc = new Interface({
 *   name: ...,
 *   schema: ...,
 *   members: ...
 * })
