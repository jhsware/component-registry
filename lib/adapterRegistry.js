...
AdapterRegistry.prototype.getAdapter = function (obj, implementsInterface) {
    ...
    */
    ...
    if (adapters) {
        ...
        if (!(obj._implements && obj._implements.length > 0)) {
            throw new AdapterRegistryException(
    ...
    var message = "No adapter found that was registered for specified object\n "
        + "implements: [" + implementsInterface.name + "] " + implementsInterface.interfaceId + "\n"
        + "adapts: " +  adaptsInterfaces + "\n"
        + "context: " + contextInterfaces;
    ...
    throw new AdapterRegistryException(
        message, 
        {
            context: obj, 
            implements: implementsInterface,
            adaptsInterfaces: adapters.interfaceAdapters,
            registry: this
        }
    );
}
