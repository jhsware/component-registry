...
import { isDevelopment, TRegister } from './common'
...
export type TAdapterRegistry = {
  ...
  getAdapter(obj: ObjectPrototype<any> | ObjectInterface | MarkerInterface, implementsInterface: AdapterInterface): Adapter<any>;
  register: TRegister;
}
