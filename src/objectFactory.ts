...
export type TObjectPrototype<T> = {
  new(
...
type TObjectPrototypeFactory<T> = {
  extends?: TObjectPrototype<any>[],
  implements?: TInterface[],
  //constructor?(data?: T): any,
  constructor: Function,
  new(data?: T): T,
}


export function createObjectPrototype<T>(params: Omit<TObjectPrototypeFactory<T>, 'new'>) {
  /*
  ...
  */
  ...
  class ObjectPrototype implements TObjectPrototype<T> {
    _implements;
    _extends;
    toJSON: any;
  ...
  if (params.hasOwnProperty('constructor')) {
    ...
    Object.defineProperty(ObjectPrototype, '_constructor', { value: constructor, writable: false, configurable: false});
  };
  ...
  if (Array.isArray(implementsInterfaces) && implementsInterfaces.length > 0) {
    ...
    Object.defineProperty(ObjectPrototype, '_iname', { value: implementsInterfaces[0].name, writable: false, configurable: false});
  };
